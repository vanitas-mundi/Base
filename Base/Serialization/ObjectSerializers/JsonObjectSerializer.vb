...
Namespace Serialization.ObjectSerializers
	...
	Public Class JsonObjectSerializer(Of T As {Class})
...
#Region " --------------->> Öffentliche Methoden der Klasse "
		...
		Implements ISerializationOf(Of T).ObjectToFile
			...
			Serializer.Json.ObjectToFile(Of T)(obj, fileName)
		End Sub
		...
		Implements ISerializationOf(Of T).ObjectToStream
			...
			Serializer.Json.ObjectToStream(Of T)(obj, stream)
		End Sub
		...
		Implements ISerializationOf(Of T).ObjectFromFile
			...
			Return Serializer.Json.ObjectFromFile(Of T)(fileName)
		End Function
		...
		Implements ISerializationOf(Of T).ObjectFromStream
			...
			Return Serializer.Json.ObjectFromStream(Of T)(stream)
		End Function
		...
		Implements ISerializationOf(Of T).CloneObject
			...
			Return Serializer.Json.CloneObject(Of T)(obj)
		End Function
		...
		Implements ISerializationOf(Of T).IsDataEqualTo
			...
			Return Serializer.Json.IsDataEqualTo(Of T)(obj, obj2)
		End Function
