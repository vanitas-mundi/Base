...
Namespace Serialization.ObjectSerializers
	...
	Public Class XmlObjectSerializer(Of T As {Class})
...
#Region " --------------->> Öffentliche Methoden der Klasse "
		...
		Implements ISerializationOf(Of T).ObjectToFile
			...
			Serializer.Xml.ObjectToFile(Of T)(obj, fileName)
		End Sub
		...
		Implements ISerializationOf(Of T).ObjectToStream
			...
			Serializer.Xml.ObjectToStream(Of T)(obj, stream)
		End Sub
		...
		Implements ISerializationOf(Of T).ObjectFromFile
			...
			Return Serializer.Xml.ObjectFromFile(Of T)(fileName)
		End Function
		...
		Implements ISerializationOf(Of T).ObjectFromStream
			...
			Return Serializer.Xml.ObjectFromStream(Of T)(stream)
		End Function
		...
		Implements ISerializationOf(Of T).CloneObject
			...
			Return Serializer.Xml.CloneObject(Of T)(obj)
		End Function
		...
		Implements ISerializationOf(Of T).IsDataEqualTo
			...
			Return Serializer.Xml.IsDataEqualTo(Of T)(obj, obj2)
		End Function
