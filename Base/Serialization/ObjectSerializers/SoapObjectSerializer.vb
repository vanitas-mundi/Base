...
Namespace Serialization.ObjectSerializers
	...
	Public Class SoapObjectSerializer(Of T As {Class})
...
#Region " --------------->> Öffentliche Methoden der Klasse "
		...
		Implements ISerializationOf(Of T).ObjectToFile
			...
			Serializer.Soap.ObjectToFile(Of T)(obj, fileName)
		End Sub
		...
		Implements ISerializationOf(Of T).ObjectToStream
			...
			Serializer.Soap.ObjectToStream(Of T)(obj, stream)
		End Sub
		...
		Implements ISerializationOf(Of T).ObjectFromFile
			...
			Return Serializer.Soap.ObjectFromFile(Of T)(fileName)
		End Function
		...
		Implements ISerializationOf(Of T).ObjectFromStream
			...
			Return Serializer.Soap.ObjectFromStream(Of T)(stream)
		End Function
		...
		Implements ISerializationOf(Of T).CloneObject
			...
			Return Serializer.Soap.CloneObject(Of T)(obj)
		End Function
		...
		Implements ISerializationOf(Of T).IsDataEqualTo
			...
			Return Serializer.Soap.IsDataEqualTo(Of T)(obj, obj2)
		End Function
